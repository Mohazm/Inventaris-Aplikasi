...
class StafBorrowerController extends Controller
{
    /**
  ...
  public function index(Request $request)
  {
    ...
    //   dd($borrowers);
      return view('staff.borrowers.index', compact('borrowers', 'teachers', 'students'));
    ...
    {
        return view('staff.borrowers.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('stafborrowers.index')->with('success', 'Peminjam berhasil ditambahkan');
    }
