                    ...
                    <tr class="align-middle">
                        ...
                        <td>
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="{{ route('StafTransactions_out.edit', $transaction->id) }}" class="btn btn-outline-warning btn-sm">
                                    <i class="bi bi-pencil-square"></i> Edit
                                </a>
                                <form action="{{ route('StafTransactions_out.destroy', $transaction->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
