...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('staff.borrowers.create') }}" class="btn btn-primary mb-3">Tambah Peminjam</a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('staff.borrowers.edit', $borrower) }}" class="btn btn-warning btn-sm">Edit</a>
                                <form action="{{ route('staff.borrowers.destroy', $borrower) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
