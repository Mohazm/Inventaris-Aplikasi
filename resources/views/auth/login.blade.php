        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
                <div class="w-100 d-flex justify-content-center">
                    <img src="{{ asset('Logo/manajemend.png')}}" alt="Login image" width="400"
                ...
                <div class="w-px-400 mx-auto">
                    ...
                    <div class="app-brand mb-5">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <div class="app-brand" style="display: flex; flex-direction: column; align-items: Start;">
                                <span class="app-brand-text  text-body fw-bold" style="font-size: 25px">Manajemen Inventaris</span>
                                <span class="app-brand-barang  text-body fw-bold " style="font-size: 20px" >Barang</span>
                            </div>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-2">Selamat Datang MainBar 👋</h4>
                    {{-- <p class="mb-4">Login Jika Anda Termasuk Anggota</p> --}}
                    ...
                    <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                placeholder="Enter your email or Email" autofocus>
                            @error('email')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Pastikan Anda telah menyertakan Font Awesome untuk ikon -->
                    <link rel="stylesheet"
