    ...
    <div class="max-w-4xl mx-auto mt-10">
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <form action="{{ route('tabungan.siswa.edit', $siswa->id) }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="block text-gray-700">Jumlah Yang Ditabung</label>
                    <input type="number" name="Uang_Masuk" value="{{ old('Uang_Masuk') }}"
                        class="w-full p-3 border rounded-lg focus:ring focus:ring-purple-400">
                    @error('Uang_Masuk')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div class="mb-4">
                    <label class="block text-gray-700">Jumlah Yang Ditabung</label>
                    <input type="number" name="Uang_Keluar" value="{{ old('Uang_Keluar') }}"
                        class="w-full p-3 border rounded-lg focus:ring focus:ring-purple-400">
                    @error('Uang_Keluar')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <button type="submit"
                    class="bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-800 transition">Update</button>
            </form>
        </div>
    </div>
@endsection
